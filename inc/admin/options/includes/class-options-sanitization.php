...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'dewi' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'dewi' ),
		'repeat-y'  => __( 'Repeat Vertically', 'dewi' ),
		'repeat'    => __( 'Repeat All', 'dewi' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'dewi' ),
		'top center'    => __( 'Top Center', 'dewi' ),
		'top right'     => __( 'Top Right', 'dewi' ),
		'center left'   => __( 'Middle Left', 'dewi' ),
		'center center' => __( 'Middle Center', 'dewi' ),
		'center right'  => __( 'Middle Right', 'dewi' ),
		'bottom left'   => __( 'Bottom Left', 'dewi' ),
		'bottom center' => __( 'Bottom Center', 'dewi' ),
		'bottom right'  => __( 'Bottom Right', 'dewi')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'dewi' ),
		'fixed'  => __( 'Fixed in Place', 'dewi')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'dewi' ),
		'italic'      => __( 'Italic', 'dewi' ),
		'bold'        => __( 'Bold', 'dewi' ),
		'bold italic' => __( 'Bold Italic', 'dewi' )
		);
