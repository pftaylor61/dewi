...
Dewi is a responsive multipurpose theme. It was originally coded under the name Spacious by ThemeGrill (http://themegrill.com). I used the theme on my own site, amending it with a child theme. This worked up to Spacious version 1.3.3. However, Spacious version 1.3.4 broke my website, as many of the functions had been completely rewritten, in a manner that was incompatible with my child theme. I have therefore made a custom fork of the theme, pegged at version 1.3.3. This will gradually be amended, until it is an independent theme. It must, however, be emphasized that the vast majority of the code in this theme came from ThemeGrill. 
...
Dewi WordPress Theme, Copyright 2015 Old Castle Web Services
Dewi is distributed under the terms of the GNU GPL

Based on the original code of the Spacious theme from ThemeGrill.
...
== CHANGE LOG ==
= Version 1.3.3 =
* This edition forked from the Spacious theme, by incorporating the code from the OCWS-Spacious Child Theme with the original code, and making refinements.
...
* Options Framework textdomain 'textdomain' changed to 'dewi'.
